...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "HyperSDK",
            url: "https://public.releases.juspay.in/release/ios/hyper-sdk/2.2.7.5/HyperSDK.zip",
            checksum: "d577dea626fc954b7671c4fabd47e29f37c4bd4b2f371b9082906dc1b7d7c00f"
        ),
        .binaryTarget(
            name: "AirborneSDK",
