...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "HyperSDK",
            url: "https://public.releases.juspay.in/release/ios/hyper-sdk/2.2.5.9/HyperSDK.zip",
            checksum: "336fc89e082bfc5aeedc8e65f6bf2659a7f9f9bcc4510dcbf4e306829e050959"
        ),
        .binaryTarget(
            name: "Airborne",
